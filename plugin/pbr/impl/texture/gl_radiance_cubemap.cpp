...
bool GLRadianceCubemap::download(GraphicsContext& graphicsContext, Bitmap& bitmap)
{
    return false;
}

void GLRadianceCubemap::upload(GraphicsContext& graphicContext, uint32_t index, const Bitmap& bitmap)
{
}
