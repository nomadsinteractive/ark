...
function(add_python_extension name)
    ...
    if(WIN32)
        list(APPEND ADD_PYTHON_EXTENSION_SOURCES ${ADD_PYTHON_EXTENSION_WIN32_SOURCES})
    endif()
    ...
    if(BUILTIN_${upper_name})
        ...
        set_property(GLOBAL APPEND PROPERTY extension_${name}_link_libraries ${target_name} ${ADD_PYTHON_EXTENSION_LIBRARIES})
        target_include_directories(${target_name} PRIVATE ${ADD_PYTHON_EXTENSION_INCLUDEDIRS})
        target_compile_definitions(${target_name} PRIVATE -DPy_BUILD_CORE -DNDEBUG -DPy_BUILD_CORE_BUILTIN ${ADD_PYTHON_EXTENSION_DEFINITIONS})
