...
class ModelLoader:
    ...
    @staticmethod
    def nine_patch_quad(atlas: Atlas) -> ModelLoader: ...
    @staticmethod
    def nine_patch_triangle_strip(atlas: Atlas) -> ModelLoader: ...
    @staticmethod
    def text(alphabet: Alphabet, atlas: Atlas, font: Font) -> ModelLoader: ...
...
class Tags:
    def __init__(self, tag: Any = None, *tags: Any): ...

    @property
    def tag(self) -> Any: ...

    def add_tag(self, tag: TYPE_TYPE_ID): ...
    def has_tag(self, tag: TYPE_TYPE_ID) -> bool: ...
    def remove_tag(self, tag: TYPE_TYPE_ID): ...
...
class RenderLayer(Renderer):
    def __init__(self, model_loader: ModelLoader, shader: Shader, varyings: Varyings, visible: Boolean | None = None, discarded: Boolean | None = None, scissor: Vec4 | None = None): ...
...
class Arena:
    ...
    @property
    def layers(self) -> BoxBundle: ...

    @property
    def render_layers(self) -> BoxBundle: ...
