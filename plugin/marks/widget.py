...
class RotationEditor:
    def __init__(self, rotation: Rotation):
        ...
        self._rotation_axis = Rotation(self._theta, self._axis)
        self._rotation_euler = Rotation(0)
        self._rotation_euler.set_euler(self._euler_pitch, self._euler_yaw, self._euler_roll)
