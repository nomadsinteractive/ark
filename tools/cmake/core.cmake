...
function(ark_add_plugin_library name)
    if(ARK_BUILD_STATIC_PLUGINS)
        ark_add_static_library(${name} ${ARGN})
        target_compile_options(${name} PRIVATE -DARK_FLAG_BUILDING_PLUGIN -DARK_BUILD_STATIC)
    else()
...
add_custom_command(OUTPUT ${GENERATED_FILE_NAMES}
    COMMAND ${GENERATOR} ${ARGN} ${GENERATED_FILE_NAMES}
