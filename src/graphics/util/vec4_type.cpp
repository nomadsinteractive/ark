...
//{
//    const sp<Vec4Impl> impl = self.as<Vec4Impl>();
//    return impl ? static_cast<sp<Numeric>>(impl->x()) : sp<Numeric>::make<VariableOP1<float, V4>>(Operators::Subscript<V4, float>(0), self);
//}

//sp<Numeric> Vec4Type::vy(const sp<Vec4>& self)
//{
//    const sp<Vec4Impl> impl = self.as<Vec4Impl>();
//    return impl ? static_cast<sp<Numeric>>(impl->y()) : sp<Numeric>::make<VariableOP1<float, V4>>(Operators::Subscript<V4, float>(1), self);
//}

//sp<Numeric> Vec4Type::vz(const sp<Vec4>& self)
//{
//    const sp<Vec4Impl> impl = self.as<Vec4Impl>();
//    return impl ? static_cast<sp<Numeric>>(impl->z()) : sp<Numeric>::make<VariableOP1<float, V4>>(Operators::Subscript<V4, float>(2), self);
//}
