...
//  [[script::bindings::classmethod]]
    static void addRenderer(const sp<Renderer>& self, sp<Renderer> renderer, sp<Boolean> discarded = nullptr, RendererType::Priority priority = RendererType::PRIORITY_DEFAULT);
//  [[script::bindings::classmethod]]
