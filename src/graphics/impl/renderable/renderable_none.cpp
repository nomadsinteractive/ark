...
Renderable::Snapshot RenderableNone::snapshot(const PipelineInput& /*pipelineInput*/, const RenderRequest& /*renderRequest*/, const V3& /*postTranslate*/, StateBits /*state*/)
{
