...
//  [[script::bindings::auto]]
    RenderObject(sp<Integer> resid, sp<Vec3> position = nullptr, sp<Vec3> size = nullptr, sp<Transform> transform = nullptr, sp<Varyings> varyings = nullptr, sp<Boolean> visible = nullptr, sp<Boolean> discarded = nullptr);
//  [[script::bindings::auto]]
    RenderObject(const NamedHash& resid, sp<Vec3> position = nullptr, sp<Vec3> size = nullptr, sp<Transform> transform = nullptr, sp<Varyings> varyings = nullptr, sp<Boolean> visible = nullptr, sp<Boolean> discarded = nullptr);
