...
public:
    DrawingContext(sp<PipelineBindings> pipelineBindings, sp<RenderBufferSnapshot> bufferSnapshot, Buffer::Snapshot vertices = {}, Buffer::Snapshot indices = {}, uint32_t drawCount = 0,
