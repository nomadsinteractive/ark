...
public:
    ...
    struct Snapshot {
        ...
        void snapshotSubProperties(const std::map<String, sp<Varyings>>& subProperties, const ShaderLayout& pipelineInput, Allocator& allocator);
    };

public:
//[[script::bindings::auto]]
    Varyings() = default;
    Varyings(const ShaderLayout& pipelineInput);
