...
public:
    ...
    static String outAttributeName(const String& name, ShaderStage::Set preStage);
    ...
    static std::vector<uint32_t> compileSPIR(const String& source, ShaderStage::Set stage, Ark::RendererTarget renderTarget);
