...
public:
    ...
    static bool shouldSupportAlphaBlending(const RenderTarget::Attachment& attachment);
    ...
    static String addSourceLineNumbers(const String& source, uint32_t* baseLineNumber = nullptr);
