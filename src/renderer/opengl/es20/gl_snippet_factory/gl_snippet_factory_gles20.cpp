...
sp<GLSnippet> GLSnippetFactoryGLES20::createCoreGLSnippet(GLResourceManager& /*glResourceManager*/, const GLPipeline& /*shader*/, const sp<GLShaderBindings>& /*shaderBindings*/)
{
