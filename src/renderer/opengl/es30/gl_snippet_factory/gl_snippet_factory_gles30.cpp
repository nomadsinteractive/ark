...
sp<GLSnippet> GLSnippetFactoryGLES30::createCoreGLSnippet(GLResourceManager& glResourceManager, const Shader& shader, const sp<ShaderBindings>& shaderBindings)
{
