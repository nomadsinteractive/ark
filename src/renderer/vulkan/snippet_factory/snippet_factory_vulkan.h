...
public:
    virtual sp<Snippet> createCoreSnippet(ResourceManager& glResourceManager, const sp<PipelineFactory>& pipelineFactory, const sp<ShaderBindings>& shaderBindings) override;
};
