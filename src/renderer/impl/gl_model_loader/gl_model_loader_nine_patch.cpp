...
void GLModelLoaderNinePatch::load(GLElementsBuffer& buf, uint32_t type, const V& size)
{
...
void GLModelLoaderNinePatch::fillPaintingRect(GLElementsBuffer& buf, const Rect& paintRect, const Item& item) const
{
