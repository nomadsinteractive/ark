...
ImageLayer::BUILDER::BUILDER(BeanFactory& factory, const document& manifest, const sp<ResourceLoaderContext>& resourceLoaderContext)
    : _impl(factory, manifest, resourceLoaderContext, sp<RenderModelQuad::BUILDER>::make(factory, manifest, resourceLoaderContext), sp<ModelLoaderQuad::BUILDER>::make(factory, manifest)) {
}
