...
RCCDrawQuadsIndirect::RCCDrawQuadsIndirect(Model model)
    : _model(std::move(model))
{
}

sp<ShaderBindings> RCCDrawQuadsIndirect::makeShaderBindings(Shader& shader, RenderController& renderController, ModelLoader::RenderMode renderMode)
{
...
void RCCDrawQuadsIndirect::postSnapshot(RenderController& renderController, RenderLayerSnapshot& snapshot)
{
}

sp<RenderCommand> RCCDrawQuadsIndirect::compose(const RenderRequest& renderRequest, RenderLayerSnapshot& snapshot)
{
