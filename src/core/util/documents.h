...
public:
    ...
    static String getId(const document& doc, const String& defValue = String());
    static String getAttribute(const document& doc, const String& name, const String& defValue = String());
